...
\newcommand{\position}{Software Development Engineer, 2}
\newcommand{\company}{Splunk}
...
Be it working in distributed systems, lower level networking, or communication driver code quick and efficient data handling has always been an interest of mine.
I enjoy working on problems that require close to full leverage of the hardware stack it is running on.
Shepherding the massive amount of data that a modern, distributed web app can generate needs solutions that are performant while maintainable.
