...
\newcommand{\position}{Software Engineer (Developer Velocity)}
\newcommand{\company}{Docker}
...
From that I developed a love for Operating Systems and code that runs to support user layer code.
Docker is a product I've always loved using and learning.
It wields powerful systems code to essentially enable the modern internet.
