...
% Introduction
I am writing you to apply to the Embedded Systems Hardware and Software Engineer position at the Oak Ridge National Laboratory.
...
I have always enjoyed the marriage of hardware and software in a way that brings out the best performance in both.
I've always preferred using systems languages: I learned to program in C++, cut my developer teeth in C, and now use Rust as my primary language.
Working at the edge of hardware and software to take on all the varied and interesting challenges put up by the research at the lab makes me excited to apply for this role.
